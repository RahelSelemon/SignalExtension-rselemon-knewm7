...
void Message_Message::serialize(std::vector<unsigned char> &data) {
  ...
  //added code here
  put_integer(CryptoPP::Integer(this->pn), data);
  put_integer(CryptoPP::Integer(this->n), data);
...
int Message_Message::deserialize(std::vector<unsigned char> &data) {
  ...
  //Added code here
  CryptoPP::Integer pn_int, n_int;
  n += get_integer(&pn_int, data, n);
  n += get_integer(&n_int, data, n);
  this->pn = int(pn_int.ConvertToLong());
  this->n = int(n_int.ConvertToLong());
